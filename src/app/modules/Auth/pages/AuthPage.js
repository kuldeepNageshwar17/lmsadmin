  ...
  return (
      <>
        <div className="d-flex flex-column flex-root">
          {/*begin::Login*/}
          <div
              className="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-row-fluid bg-white LoginBg"
              id="kt_login"
          >
            {/*begin::Aside*/}
            <div
            ...
            >
              ...
              <div className="d-flex flex-row-fluid flex-column justify-content-between">
                {/* start:: Aside header */}
                <Link to="/" className="flex-column-auto mt-5 p-10 p-lg-10">
                  <img
                      alt="Logo"
                      className="max-h-70px"
                      src={toAbsoluteUrl("http://www.mindproc.com/resources/imx/mindproc-logo-color.png")}
                  />
                </Link>
                {/* end:: Aside header */}

                {/* start:: Aside content */}
                <div className="flex-column-fluid d-flex flex-column justify-content-center p-10 p-lg-10 LgnMsg">
                ...
                <div className="d-none flex-column-auto d-lg-flex justify-content-between mt-10 loginAsideFooter p-10 p-lg-10 ">
